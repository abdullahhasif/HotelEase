...
-- Password:   `password`
--
-- DROP DATABASE IF EXISTS hotelease;
-- CREATE DATABASE IF NOT EXISTS hotelease;

-- DROP USER IF EXISTS'hotelease_user'@'%';
-- CREATE USER IF NOT EXISTS 'hotelease_user'@'%' IDENTIFIED BY 'password';
-- GRANT ALL PRIVILEGES ON hotelease.* TO 'hotelease_user'@'%';
-- USE hotelease;
...
(12, 'Abdullah Asif', 'abdullah@gmail.com', 'Single Room', 'Single', 1, '2022-11-09', '2022-11-10', 1, 1000.00, 10.00, 'Room only', 0.00, 1010.00);
...
(41, 'Balach Khan', 'bkp.dhk@gmail.com', 'Pakistan', '03331234567', 'Single Room', 'Single', 'Room only', '1', '2022-11-09', '2022-11-10', 1, 'Confirm');
...
(1, 'Abdullah Asif', 'abdullahasif@gmail.com', '8444'),
(2, 'Ali Aoun Asif', 'aliaoun@gmail.com', '123456');
...
(1, 'Muhammad Awais', 'Manager'),
(3, 'Jawad Ur Rehman', 'Cook'),
(4, 'Roheen', 'Cook'),
(5, 'Harry Kane', 'Helper'),
(6, 'Mbappe', 'Helper'),
(7, 'Haaland', 'cleaner'),
(8, 'Ibrahimovic', 'Waiter'),
(9, 'Artaza Khalid', 'Waiter'),
(10, 'Arsalan Khan', 'Waiter'),
(11, 'Saad Wasay', 'Cook');
